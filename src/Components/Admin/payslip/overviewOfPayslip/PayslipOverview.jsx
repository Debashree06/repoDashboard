  ...
  plugins: {
    ...
    tooltip: {
      ...
      external: (context) => {
        ...
        tooltipEl.innerHTML = `<div style="${Object.entries(tooltipStyle)
          .map(([k, v]) => `${k}:${v}`)
          .join(";")}">
          <strong>${pieChartData.labels[dataIndex]}:</strong> ${pieChartData.datasets[0].data[dataIndex]}
        </div>`;
      },
    },
    datalabels: {
    ...
    <div className="pb-6 md:pb-8 lg:pb-10 ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 pb-10">
        <div className="border-2 p-4 sm:p-6 lg:p-6 flex flex-col gap-4 bg-white rounded-md">
          <h2 className="text-xl sm:text-2xl font-semibold">Payout Details</h2>
          <div>
        ...
        <div className="border-2 p-4 sm:p-6 lg:p-6 flex flex-col gap-4 bg-white rounded-md">
         ...
         <div className="bg-[#fecaca]  p-4 sm:p-6 border rounded-md w-48 sm:w-56 lg:w-64">
              <h2>5</h2>
              <h4>Total Employees</h4>
              <h4 className="text-md text-black flex gap-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-10">
        <div className="border-2 p-4 sm:p-6 lg:p-6 flex flex-col gap-5 bg-white rounded-md">
          <h2 className="text-xl sm:text-2xl font-semibold">Negative Salary</h2>
          <div className="flex items-center justify-center">
            <h3 className="p-8">No Record</h3>
          </div>
        </div>
        <div className="border-2 p-4 sm:p-6 lg:p-6 flex flex-col gap-5 bg-white rounded-md">
          <h2 className="text-xl sm:text-2xl font-semibold">Stop Salary</h2>
              ...
              <div className="flex flex-col gap-2">
                {users.map((user, index) => (
                  <div key={index} className="flex items-center gap-3">
                    <div className="bg-blue-400 h-8 w-8 flex items-center rounded-full justify-center">
                      <AiOutlineUser />
                    </div>
                    <h2>
        ...
        <div className="border-2 p-4 sm:p-6 lg:p-6 flex flex-col gap-5 bg-white rounded-md">
          <h2 className="text-xl sm:text-2xl font-semibold">Payout Pending</h2>
          <div className="flex items-center justify-center">
            <h3 className="p-8">No Record</h3>
          </div>
        </div>
