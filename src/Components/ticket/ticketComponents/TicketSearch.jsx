    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
      ...
      <div>
        <button
          ...
          className="btn btn-success w-full bg-golden text-white font-bold py-2 px-4 rounded-lg hover:bg-white hover:text-golden border border-transparent hover:border-golden transition duration-300"
        >
          Search
        </button>
      </div>
